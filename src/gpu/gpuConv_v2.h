#ifndef SRC_GPU_CONV_V2_H_
#define SRC_GPU_CONV_V2_H_

#include <vector>
#include "../layer.h"

class gpuConv_v2 : public Layer {
private:
    const int dim_in;
    int dim_out;
...
public:
    gpuConv_v2(int channel_in, int height_in, int width_in, int channel_out,
